...
export declare type userCollection = ExtendCollection<typeof original,{description: {$id: "user",properties: {roles: {type: "array",items: {enum: ["root","supervisor","customer"]}}}}}>
